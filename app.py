...
def predict():
    ...
    try:
        sa = gspread.service_account(filename="colleges.json")
    ...
    try:
        ...
        list1[2] = Category.get(list1[2], 'Unknown')
        list1[3] = Quota.get(list1[3], 'Unknown')
        list1[4] = Pool.get(list1[4], 'Unknown')
        list1[5] = Institute.get(list1[5], 'Unknown')
        ...
        return f"Error during prediction or appending to Google Sheets: {e}"
